...
async function main() {
    ...
    //  Special swap
    console.log('Special swap two loyalty tokens .........')
    const eventId = 1;
    ...
    const qMemberId = '1';
    const bAmount = 1000;
    let tx = await periphery.connect(account2).specialSwap(
        eventId, bMembership, bMemberId, qMembership, qMemberId, bAmount
    );
